...
var require$$0$3 = require('yoga-layout-prebuilt');
...
(
			false
				? require$$1.createRequire((typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('index.js', document.baseURI).href)))
				: require
		);
...
const homeDir = typeof os__default["default"].homedir === 'undefined' ? '' : os__default["default"].homedir().replace(/\\/g, '/');
...
function requireStackUtils () {
	...
	const natives = [].concat(
	  require$$1__default$1["default"].builtinModules,
	  'bootstrap_node',
	  'node',
...
function requireErrorOverview () {
	...
	const fs = __importStar(require$$0__default$3["default"]);
	const react_1 = __importDefault(requireReact());
