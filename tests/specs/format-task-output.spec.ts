...
describe('formatTaskOutput', () => {
	...
	test('single-line output gets arrow prefix', () => {
		...
		// Arrow is colored with secondary, text is colored separately
	...
	test('multi-line output: continuation lines align with first line text', () => {
		...
		// First line: indent + secondary(→) + space + outputColor(text)
		// Continuation lines: indent + 2-space padding + outputColor(text)
